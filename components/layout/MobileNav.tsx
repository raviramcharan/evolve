...
export function MobileNav({ trainingEnabled, nutritionEnabled }: Props) {
  ...
  const tabs = [
    ...
    { href: '/check-in',   label: 'Check-in',  icon: ClipboardCheck,  show: true },
    { href: '/training',   label: 'Training',  icon: Dumbbell,        show: trainingEnabled },
    { href: '/nutrition',  label: 'Nutrition', icon: Utensils,        show: nutritionEnabled },
